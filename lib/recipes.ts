...
export const recipes: Recipe[] = [
  base({ id: 'ugali-sukuma', name: 'Ugali & Sukuma Wiki', category: 'Ugali', mealType: 'Dinner', description: 'The dependable Kenyan classic: firm ugali with garlicky, tender greens.', ingredients: [{ name: 'Maize flour', amount: '2 vikombe' }, { name: 'Sukuma wiki', amount: '1 bunch' }, { name: 'Tomato', amount: '2' }, { name: 'Onion', amount: '1' }, { name: 'Oil', amount: '2 tbsp' }], totalTime: 30, cookTime: 22, estimatedCost: { min: 70, max: 130 }, image: photo('photo-1601050690597-df0568f70950'), tags: ['One-pot', 'Bachelor-friendly'], dietaryInfo: ['Vegetarian']}),
